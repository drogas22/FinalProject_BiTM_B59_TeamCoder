...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="view.php">Current Page</a></li>
                <li class="active"><a href="email.php">Email Controller</a></li>
    ...
    <div class="col-md-3" style="margin-top: 56px;height: 130px;width: 220px;margin-left: 100px">
        <div class="thumbnail ">
                ...
                <img src="Profile/uploads/<?php echo $singleUser->image ?>"
