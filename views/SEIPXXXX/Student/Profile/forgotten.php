...
if(isset($_POST['email'])) {
    ...
    $mail->AddReplyTo("tsatsouline2","Leader Of TeamCoder");
    $mail->Subject    = "Your Password Reset Link";
    $message =  "Please click this link to reset your password: 
       http://localhost/FinalProject_BiTM_B59_TeamCoder/views/SEIPXXXX/Student/Profile/resetpassword.php?email=".$_POST['email']."&code=".$singleUser->password;
