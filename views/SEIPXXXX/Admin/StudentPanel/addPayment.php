...
<div class="container width" style="padding-top: 2%">
    ...
    <div class="content panel panel-default form-horizontal createbg">
        <h3 class="panel-heading text-center">INPUT Payment</h3>
        <form action="storePayment.php" method="post" class="panel-body">
            <div>
                <label>ID</label>
                <input type="text" name="id" value="<?php echo $_GET['id'] ?>">
            </div>
            <div class="">
                <input type="number" name="payment" placeholder="Enter the amount here">
            </div>
            <div>
